...
public class RestClient {
    ...
    {
        AddParam(name, Double.valueOf(value).toString());
    }
    ...
    public void Execute_(RequestMethod method) throws Exception
    {
        switch(method) {
            case GET:
            {
	...
	public boolean isOk()
	{
		...
		if(responseCode == HttpURLConnection.HTTP_ACCEPTED) return true;
	...
	public boolean isOkAndHasString()
	{
